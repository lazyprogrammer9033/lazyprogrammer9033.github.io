...
const phrases = [
  ...
  'Founder of AI School for Kids',
  'AI Educator for Young Minds',
  'Technology Analyst',
  ...
  entries.forEach((entry) => {
    if (entry.isIntersecting) {
      ...
      siblings.forEach((el, idx) => {
        setTimeout(() => el.classList.add('aos-visible'), idx * 100);
      });
...
// Safety fallback: if elements are already in viewport on load, show them
setTimeout(() => {
...
/* ─────────────────────────────────────────
   SKILL BARS – animate when visible
───────────────────────────────────────── */
...
/* ─────────────────────────────────────────
   CONTACT FORM – prevent default + toast
───────────────────────────────────────── */
